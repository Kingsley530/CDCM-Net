...
from nets.deeplabv3_plus_contextguidefpn_change_attention_EMAaspp_mulattention_EMSCP import DeepLab
...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    # model_path = "E:/wsw/UNet/deeplabv3-plus-pytorch-main/deeplabv3-plus-pytorch-main/model_data/deeplab_xception.pth"
    model_path = ""
    # ---------------------------------------------------------#
    ...
    # ------------------------------------------------------------------#
    save_dir = 'E:/wsw/UNet/runs/CFDnew3/deeplabv3_plus_contextguidefpn_change_attention_EMAaspp_mulattention_EMSCP'
    # save_dir = 'F:/wsw/UNet/runs/crack/deeplabv3_plus_ori'
    # ------------------------------------------------------------------#
    ...
    # ------------------------------------------------------------------#
    # VOCdevkit_path  = 'autodl-tmp/deeplabv3-plus-pytorch-main/deeplabv3-plus-pytorch-main/VOCdevkit/'
    # VOCdevkit_path = 'E:/wsw/UNet/dataset/新建文件夹/concrete'
    VOCdevkit_path = 'E:/wsw/UNet/dataset/CFDnew3'
    # VOCdevkit_path = 'E:/wsw/UNet/dataset/crack'
    # ------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    # ------------------------------------------------------------------#
    cls_weights = np.ones([2], np.float32)
    # ------------------------------------------------------------------#
    ...
    # with open(os.path.join(VOCdevkit_path, "VOC2007/ImageSets/Segmentation/train.txt"),"r") as f:
    #with open(os.path.join("./VOCdevkit/VOC2007/ImageSets/Segmentation/train.txt"), "r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "./VOC2007/ImageSets/Segmentation/val.txt"),"r") as f:
    #with open(os.path.join("./VOCdevkit/VOC2007/ImageSets/Segmentation/val.txt"), "r") as f:
    ...
    # ------------------------------------------------------#
    #   主干特征提取网络特征通用，冻结训练可以加快训练速度D:\pythonject\pythonProject3\deeplabv3-plus-pytorch-main\deeplabv3-plus-pytorch-main\VOCdevkit\VOC2007\ImageSets\Segmentation\train
    #   也可以在训练初期防止权值被破坏。
    #   Init_Epoch为起始世代
    ...
    if True:
        ...
        #train_dataset = DeeplabDataset(train_lines, input_shape, num_classes, True, "VOCdevkit")
        #val_dataset = DeeplabDataset(val_lines, input_shape, num_classes, False, "VOCdevkit")
